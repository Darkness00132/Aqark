...
import { getAllAds, getMyAds, getAdBySlug, createAd, updateAd, deleteAd, incrementWhatsappClicks, getMyAd, getSitemapAds, getMyWishlist, addToWishlist, } from "../controller/ads.controller.js";
const router = Router();
